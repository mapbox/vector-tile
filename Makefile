...
./.mason/mason:
	mkdir ./.mason
	curl -sSfL https://github.com/mapbox/mason/archive/e78d6d7c729f05e53a77f6156056974d13b8c32f.tar.gz | tar --gunzip --extract --strip-components=1 --exclude="*md" --exclude="test*" --directory=./.mason
